...
export function AdminNewsletterLoginForm() {
      ...
      <div className="w-full max-w-md bg-zinc-900/90 border border-brand-purple/30 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl relative z-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black text-white tracking-tight">
            Painel da Newsletter
          </h1>
          <p className="text-xs text-zinc-400">
            Digite a Chave Mestra para controlar a habilitação do envio semanal e gerenciar assinantes.
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl font-black text-sm bg-gradient-to-r from-brand-purple via-purple-600 to-brand-cyan text-white shadow-lg shadow-brand-purple/25 hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer"
          >
            <span>{loading ? "Validando Acesso..." : "Entrar no Painel da Newsletter"}</span>
        ...
        <div className="text-center pt-2">
          <a
            href="/"
            className="text-xs text-zinc-500 hover:text-brand-purple transition-colors"
          >

...
| `GET /api/metrics/public` | [app/api/metrics/public/route.ts](file:///d:/IAProjects/AIGamePortal/app/api/metrics/public/route.ts) | Route Handler Público | `300s` (5m Edge Cache) | Endpoint público sanitizado expondo apenas contadores de posts e plataformas. |

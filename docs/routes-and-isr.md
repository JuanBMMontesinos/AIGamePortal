...
| `GET /noticias/[slug]` | [app/noticias/[slug]/page.tsx](file:///d:/IAProjects/AIGamePortal/app/noticias/[slug]/page.tsx) | Estático (SSG + ISR) | `300s` ou via webhook | Matéria completa com TL;DR, Ficha Técnica, Sentimento, E-E-A-T e JSON-LD. |
...
| `GET /jogos/[slug]` | [app/jogos/[slug]/page.tsx](file:///d:/IAProjects/AIGamePortal/app/jogos/[slug]/page.tsx) | Estático (SSG + ISR) | `300s` ou via webhook | Central do jogo com Hero, Ficha Técnica, Linha do Tempo, Onde Comprar e Schema VideoGame. |
